...
/**
    ...
    *    3.0 (09.10.2020) export default was missing to make a wepack bundle and eslint happy
    **/
...
export default class SoSIE {
  ...
  constructor (configuration, custom) {
    ...
    if (!custom) {
      this.addMenuItemLogo({
        ...
        text: '(0.3.0) based on editor.js by sos-productions\n Big Thanks to the Codex Team for editor.js!',
    ...
    if (!custom) {
      window.SoSIE__plugins.forEach(function (plugin) {
        if (Object.prototype.hasOwnProperty.call(window, 'sample' + plugin)) window['sample' + plugin](editor)
      })
    }
  ...
  static register (plugin) {
    if (typeof plugins === 'undefined') window.SoSIE__plugins = []
  ...
  _inject (anchor, interactive, url, title, mode, custom) {
    ...
    })(url, interactive, title, mode || 'inline', custom || false)
  }
  ...
  init (editor) {
    ...
    window.SoSIE__plugins.forEach(function (plugin) {
      if (Object.prototype.hasOwnProperty.call(window, plugin) && (typeof window[plugin].init !== 'undefined')) {
